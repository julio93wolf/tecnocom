<?php
	...
	if (isset($_POST['enviar'])) {
		$paraInsSubcategoria['id_categoria']=$_POST['id_categoria'];
		$paraInsSubcategoria['subcategoria']=$_POST['subcategoria'];
		$rowChange=$tecnocom->insertar('subcategoria',$paraInsSubcategoria);			
		if ($rowChange>0) {
