...
insert into compra_detalle values (2,21,2,8999.00);

insert into compra values (null,2,'2017-07-26',16192.00,2590.72,18782.72);
insert into compra_detalle values (3,3,1,1299.00);
insert into compra_detalle values (3,8,1,1699.00);
insert into compra_detalle values (3,10,1,1499.00);
insert into compra_detalle values (3,14,1,4299.00);
insert into compra_detalle values (3,17,1,699.00);
insert into compra_detalle values (3,20,1,3199.00);
insert into compra_detalle values (3,22,1,299.00);
insert into compra_detalle values (3,29,1,3199.00);